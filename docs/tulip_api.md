...
amy.send(synth=1, num_voices=1, load_patch=129, note=45, vel=1) # plays a tone
amy.send(synth=1, pan=0) # set to the right channel
amy.send(synth=1, pan=1) # set to the left channel
...
amy.send(synth=1, num_voices=1, load_patch=101, note=50, vel=1) # all Alles speakers in a mesh will respond
amy.send(synth=1, num_voices=1, load_patch=101, note=50, vel=1, client=2) # just a certain client
```
