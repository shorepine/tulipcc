...
class ArpeggiatorSynth:
    ...
    def next_note(self, t):
        if self.current_note:
            self.synth.note_off(self.current_note, time=t)
        ...
        if self.full_sequence:
            ...
            self.synth.note_on(self.current_note, self.velocity, time=t)
        else:
            self.running = False
    ...
    def set(self, arg, val=None):
        ...
        if arg == 'on':
            ...
            # now convert period_ms to BPM
            seq_bpm((1000.0 / self.period_ms)*60.0)
        elif arg == 'octaves':
            self.octaves = val
        else:
            self.direction = arg
