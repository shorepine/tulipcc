...
def cb(obj, code, ui_id):
    ...
    if(ui_id==2 or ui_id==3):
        slider = obj
        print("slider %d is %f" % (ui_id, slider.get_value()/100.0))
...
tulip.ui_slider(ui_id=2, val=0.5, x=300, y=400, w=15, h=150, bar_color=151, handle_color=188)
tulip.ui_slider(ui_id=3, val=0.5, x=250, y=300, w=400, bar_color=255, handle_color=0)
