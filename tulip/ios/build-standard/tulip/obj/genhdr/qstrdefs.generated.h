...
QDEF(MP_QSTR_VfsLfs1, 30190, 7, "VfsLfs1")
...
QDEF(MP_QSTR__tulip, 42446, 6, "_tulip")
...
QDEF(MP_QSTR_algo_setup, 17560, 10, "algo_setup")
QDEF(MP_QSTR_alles_send, 10321, 10, "alles_send")
QDEF(MP_QSTR_app_path, 55702, 8, "app_path")
...
QDEF(MP_QSTR_bg_bezier, 28476, 9, "bg_bezier")
QDEF(MP_QSTR_bg_bitmap, 22396, 9, "bg_bitmap")
QDEF(MP_QSTR_bg_blit, 2796, 7, "bg_blit")
QDEF(MP_QSTR_bg_char, 40647, 7, "bg_char")
QDEF(MP_QSTR_bg_circle, 46893, 9, "bg_circle")
QDEF(MP_QSTR_bg_clear, 22694, 8, "bg_clear")
QDEF(MP_QSTR_bg_fill, 61136, 7, "bg_fill")
QDEF(MP_QSTR_bg_line, 50641, 7, "bg_line")
QDEF(MP_QSTR_bg_pixel, 50839, 8, "bg_pixel")
QDEF(MP_QSTR_bg_png, 52166, 6, "bg_png")
QDEF(MP_QSTR_bg_rect, 27263, 7, "bg_rect")
QDEF(MP_QSTR_bg_roundrect, 60957, 12, "bg_roundrect")
QDEF(MP_QSTR_bg_scroll, 6834, 9, "bg_scroll")
QDEF(MP_QSTR_bg_scroll_x_offset, 36167, 18, "bg_scroll_x_offset")
QDEF(MP_QSTR_bg_scroll_x_speed, 18445, 17, "bg_scroll_x_speed")
QDEF(MP_QSTR_bg_scroll_y_offset, 10278, 18, "bg_scroll_y_offset")
QDEF(MP_QSTR_bg_scroll_y_speed, 38092, 17, "bg_scroll_y_speed")
QDEF(MP_QSTR_bg_str, 55946, 6, "bg_str")
QDEF(MP_QSTR_bg_swap, 16906, 7, "bg_swap")
QDEF(MP_QSTR_bg_touch_callback, 16012, 17, "bg_touch_callback")
QDEF(MP_QSTR_bg_touch_del, 21800, 12, "bg_touch_del")
QDEF(MP_QSTR_bg_touch_register, 28908, 17, "bg_touch_register")
QDEF(MP_QSTR_bg_touch_up, 48864, 11, "bg_touch_up")
QDEF(MP_QSTR_bg_triangle, 51185, 11, "bg_triangle")
...
QDEF(MP_QSTR_brightness, 50764, 10, "brightness")
QDEF(MP_QSTR_btree, 37345, 5, "btree")
QDEF(MP_QSTR_buffering, 56101, 9, "buffering")
QDEF(MP_QSTR_build_strings, 44330, 13, "build_strings")
...
QDEF(MP_QSTR_collisions, 34280, 10, "collisions")
...
QDEF(MP_QSTR_display_clock, 7144, 13, "display_clock")
QDEF(MP_QSTR_display_restart, 40823, 15, "display_restart")
QDEF(MP_QSTR_display_start, 51072, 13, "display_start")
QDEF(MP_QSTR_display_stop, 39224, 12, "display_stop")
...
QDEF(MP_QSTR_edit, 27545, 4, "edit")
...
QDEF(MP_QSTR_fps, 14528, 3, "fps")
QDEF(MP_QSTR_frame_callback, 13294, 14, "frame_callback")
...
QDEF(MP_QSTR_gpu, 15559, 3, "gpu")
QDEF(MP_QSTR_gpu_log_start, 1251, 13, "gpu_log_start")
QDEF(MP_QSTR_gpu_log_stop, 20219, 12, "gpu_log_stop")
QDEF(MP_QSTR_gpu_reset, 48717, 9, "gpu_reset")
...
QDEF(MP_QSTR_int_screenshot, 6917, 14, "int_screenshot")
...
QDEF(MP_QSTR_midi_callback, 58042, 13, "midi_callback")
QDEF(MP_QSTR_midi_in, 33300, 7, "midi_in")
QDEF(MP_QSTR_midi_out, 56221, 8, "midi_out")
...
QDEF(MP_QSTR_multicast_start, 48182, 15, "multicast_start")
...
QDEF(MP_QSTR_sprite_bitmap, 5968, 13, "sprite_bitmap")
QDEF(MP_QSTR_sprite_clear, 34890, 12, "sprite_clear")
QDEF(MP_QSTR_sprite_move, 35650, 11, "sprite_move")
QDEF(MP_QSTR_sprite_off, 19452, 10, "sprite_off")
QDEF(MP_QSTR_sprite_on, 16466, 9, "sprite_on")
QDEF(MP_QSTR_sprite_png, 60266, 10, "sprite_png")
QDEF(MP_QSTR_sprite_register, 7578, 15, "sprite_register")
...
QDEF(MP_QSTR_tfb_log_start, 61489, 13, "tfb_log_start")
QDEF(MP_QSTR_tfb_log_stop, 31849, 12, "tfb_log_stop")
QDEF(MP_QSTR_tfb_restore, 10466, 11, "tfb_restore")
QDEF(MP_QSTR_tfb_save, 15947, 8, "tfb_save")
QDEF(MP_QSTR_tfb_start, 3978, 9, "tfb_start")
QDEF(MP_QSTR_tfb_stop, 1906, 8, "tfb_stop")
QDEF(MP_QSTR_tfb_str, 11999, 7, "tfb_str")
...
QDEF(MP_QSTR_timing, 9013, 6, "timing")
QDEF(MP_QSTR_touch, 58752, 5, "touch")
QDEF(MP_QSTR_touch_callback, 1430, 14, "touch_callback")
QDEF(MP_QSTR_touch_delta, 24807, 11, "touch_delta")
QDEF(MP_QSTR_trunc, 39259, 5, "trunc")
QDEF(MP_QSTR_uctypes, 29176, 7, "uctypes")
QDEF(MP_QSTR_ui_active, 26666, 9, "ui_active")
QDEF(MP_QSTR_ui_button, 5040, 9, "ui_button")
QDEF(MP_QSTR_ui_callback, 51279, 11, "ui_callback")
QDEF(MP_QSTR_ui_checkbox, 56661, 11, "ui_checkbox")
QDEF(MP_QSTR_ui_del, 31627, 6, "ui_del")
QDEF(MP_QSTR_ui_slider, 27427, 9, "ui_slider")
QDEF(MP_QSTR_ui_text, 45339, 7, "ui_text")
...
QDEF(MP_QSTR_window, 50057, 6, "window")
