...
# GAMMA9001 builds (Tulip hardware/web, AMYboard) bake the full Gamma9001
# TR-808 bank as AMY's ROM set (see amy pcm_gamma808.h); Tulip Desktop still
# compiles pcm_tiny.
try:
    from tulip import board
    _gamma9001 = board() != 'DESKTOP'
except ImportError:
    _gamma9001 = False
